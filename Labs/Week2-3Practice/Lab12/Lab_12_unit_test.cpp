...
CHECK(item.ToString() == "magicitem, $0, no description, requires 0 
mana");
}
...
CHECK(item.ToString() == "staff, $999, carved wood, requires 125 
mana");
}
SECTION("Accessors / Mutators") {
MagicItem item;
...
CHECK(item.ToString() == "wand, $1000, jewel-encrusted, requires 50 
mana");
}
}
*/